...
<div class="text-nowrap">
    <div class="border p-3 rounded">
        <div class="d-lg-flex flex-wrap">
            ...
            <div class="p-1 flex-fill"><?=$form->field($model,'material_id')->widget(Select2::class, [
            ...
            <div class="p-1"><?=$form->field($model,'length')->widget(LabelInPlace::class,[
                    'type' => LabelInPlace::TYPE_HTML5,
                    'options' => ['type' => 'text']
                ])->label(false) ?>
            </div>
            <div class="p-1"><?=$form->field($model,'width_from')->widget(LabelInPlace::class,[
                    'type' => LabelInPlace::TYPE_HTML5,
                    'options' => ['type' => 'text']
                ])->label(false) ?>
            </div>
            <div class="p-1"><?=$form->field($model,'width_to')->widget(LabelInPlace::class,[
                    'type' => LabelInPlace::TYPE_HTML5,
                    'options' => ['type' => 'text']
                ])->label(false) ?>
            </div>
