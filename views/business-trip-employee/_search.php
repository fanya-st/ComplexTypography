...
<div class="text-nowrap">
    <div class="border p-3 rounded">
        <div class="d-lg-flex flex-wrap">
            ...
            <div class="p-1 flex-lg-fill"><?php echo $form->field($model,'customer_id')->widget(Select2::class, [
            ...
            <div class="p-1 flex-lg-fill"><?php echo $form->field($model,'status_id')->widget(Select2::class, [
            ...
            <div class="p-1 flex-fill"><?php echo $form->field($model,'transport_id')->widget(Select2::class, [
            ...
            <div class="p-1 flex-lg-fill"><?php echo $form->field($model,'date_range')->widget(DateRangePicker::class, [
