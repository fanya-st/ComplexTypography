...
<div class="text-nowrap">
    <div class="border p-3 rounded">
        <div class="d-lg-flex flex-wrap">
            ...
            <div class="p-1 flex-fill"><?php echo $form->field($model,'designer_id')->widget(Select2::class, [
            ...
            <div class="p-1 flex-fill"><?php echo $form->field($model,'customer_id')->widget(Select2::class, [
            ...
            <div class="p-1 flex-fill"><?php echo  $form->field($model, 'pants_id')->widget(Select2::class, [
            ...
            <div class="p-1 flex-fill"><?php echo $form->field($model,'date_of_create')->widget(DateRangePicker::class,['options' => ['placeholder' => 'Дата создания'],'presetDropdown' => true,'pluginOptions' => [
                'opens'=>'left'
                ]])->label(false)?></div>
        </div>
    </div>
