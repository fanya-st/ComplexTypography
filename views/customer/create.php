...
<div class="row">
    <div class="col">
        ...
        <?php echo $form->field($customer, 'time_to_delivery_to')->widget(TimePicker::classname(), [
            'pluginOptions'=>[
                'showMeridian'=>false,
            ]
        ]) ?>
        <?php echo Html::submitButton('Добавить заказчика',['class'=>'btn btn-success'])?>
    </div>
    <div class="col">
        ...
        ?>
        <?php echo $form->field($customer,'region_id')->widget(DepDrop::classname(), [
        ...
        <?php echo $form->field($customer,'town_id')->widget(DepDrop::classname(), [
            'type' => DepDrop::TYPE_SELECT2,
            'options'=>['id'=>'town-id'],
            'pluginOptions'=>[
                'allowClear' => true,
        ...
        <?php echo $form->field($customer,'street_id')->widget(DepDrop::classname(), [
            'type' => DepDrop::TYPE_SELECT2,
            'pluginOptions'=>[
                'allowClear' => true,
                'depends'=>['town-id'],
        ...
        ?>
        <?php echo $form->field($customer, 'comment')->widget(LabelInPlace::classname(), [
